...
const WorkExperience = () => {
  return (
    <section
      className="max-w-screen-xl mx-auto pb-0 md:pb-20 px-6 pd:px-20 relative"
      id="experience"
    >
    ...
    <div className="relative">
      ...
      <div className="bg-gradient-to-br from-blue-950 to-slate-900 rounded-lg border border-blue-800/40 p-4 mx-0 md:mx-10 md:absolute top-[70px] mb-6 md:mb-0">
        <div className="flex items-center justify-between flex-1">
          <div>
            <p className="text-white tex-[13.5px] md:text-base font-medium leading-4 md:leading-5">
              {company}
            </p>
