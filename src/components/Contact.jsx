  ...
  return (
    <section className="max-w-screen-xl mx-auto px-6 pb-20" id="contact">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 md:gap-16">
        <div>
          <ContactInfoCard
            icon={<IoMdMail className="text-2xl text-blue-400" />}
            text={PROFILE_DATA.email}
          />
          <ContactInfoCard
            icon={<IoPhonePortraitOutline className="text-2xl text-blue-400" />}
            text={PROFILE_DATA.phone}
          />
          <ContactInfoCard
            icon={<MdOutlineWeb className="text-2xl text-blue-400" />}
